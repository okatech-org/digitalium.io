...
export const ADMIN_PAGE_INFO: PageInfoMap = injectArchitecture({
    ...
    "organizations/detail": {
        pageId: "admin-org-detail",
        titre: "Fiche Organisation",
        but: "Configurer entièrement une organisation : identité, structure, classement, modules et déploiement.",
        description: "Page de configuration complète d'une organisation en 6 onglets. Chaque onglet correspond à une étape de préparation — de la saisie du profil jusqu'au déploiement final. La barre de progression en haut indique l'avancement global.",
        elements: [
            { nom: "Bandeau de progression", type: "carte", description: "Indicateurs visuels d'avancement par onglet — cliquez sur un cercle pour naviguer vers l'onglet correspondant" },
            { nom: "Menu statut", type: "bouton", description: "Dropdown sur le badge de statut pour changer l'état de l'organisation (brouillon → prête → active)" },
            { nom: "Onglet Profil", type: "champ", description: "Identité légale (raison sociale, RCCM, NIF), coordonnées et gestion des sites (siège + antennes)" },
            { nom: "Onglet Structure Org", type: "autre", description: "Organigramme : sites, unités organisationnelles, affectation des membres et rôles métier" },
            { nom: "Onglet Classement", type: "autre", description: "Structure de classement documentaire (cellules de rangement) basée sur la hiérarchie métier" },
            { nom: "Onglet Modules", type: "carte", description: "Activation/configuration des modules (iDocument, iArchive, iSignature) avec types de documents et métadonnées" },
            { nom: "Onglet Automatisation", type: "autre", description: "Règles QUAND/ALORS automatiques par module (archivage, notification, validation)" },
            { nom: "Onglet Déploiement", type: "carte", description: "Choix d'hébergement (cloud/datacenter/local), domaine et configuration du portail public" },
        ],
        tachesDisponibles: [
            "Compléter le profil et les coordonnées",
            "Définir la structure organisationnelle (sites + unités)",
            "Configurer le plan de classement documentaire",
            "Activer et paramétrer les modules",
            "Créer les règles d'automatisation",
            "Choisir le mode de déploiement et activer l'organisation",
        ],
        liens: [
            { page: "Organisations", relation: "Liste complète", route: "/admin/organizations" },
            { page: "Nouvelle Organisation", relation: "Wizard de création", route: "/admin/organizations/new" },
        ],
        conseil: "Complétez les onglets dans l'ordre (de gauche à droite). Le bandeau de progression vous guide — une fois tous les cercles verts, vous pouvez marquer l'organisation comme 'Prête' puis l'activer.",
    },
    subscriptions: {
