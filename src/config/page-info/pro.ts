...
export const PRO_PAGE_INFO: PageInfoMap = injectArchitecture({
    ...
    compliance: {
        pageId: "pro-compliance",
        titre: "Sécurité & Conformité",
        but: "Assurer la conformité réglementaire et la sécurité de l'espace professionnel.",
        ...
        liens: [
            { page: "Paramètres", relation: "Configuration de sécurité", route: "/pro/settings" },
        ],
        conseil: "Générez et exportez régulièrement vos rapports d'audit pour répondre aux exigences réglementaires.",
    },
});
