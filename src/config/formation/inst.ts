...
export const INSTITUTIONAL_FORMATION: FormationConfig = {
    ...
    fonctionnalites: [
        ...
        },
        {
            ...
            description: "Gérez la structure, les départements et les niveaux de classement de votre institution.",
            importance: "Moyenne",
            tutorielIds: ["inst-tuto-org-profile"],
        },
        {
            id: "inst-team",
            onglet: "Équipe",
            ...
            description: "Gérez les rôles métiers et les statuts des agents de votre institution.",
            importance: "Moyenne",
            tutorielIds: ["inst-tuto-team-manage"],
        },
    ],
    tutoriels: [
        {
        ...
        },
        {
            ...
            fonctionnaliteId: "inst-idocument",
            routeCible: "/inst/idocument/shared",
            etapes: [
        ...
        },
        {
            ...
            routeCible: "/inst/iarchive/legal",
            etapes: [
        ...
        },
        {
            ...
            routeCible: "/inst/isignature/pending",
            etapes: [
        ...
        {
            id: "inst-tuto-org-profile",
            titre: "Mettre à jour la structure",
            fonctionnaliteId: "inst-organization",
            routeCible: "/inst/organization",
            etapes: [
                { numero: 1, instruction: "Accédez à Mon Espace > Organisation" },
                { numero: 2, instruction: "Vérifiez le profil de l'institution", detail: "Mettez à jour les informations générales si nécessaire." },
                { numero: 3, instruction: "Gérez les niveaux de classement", detail: "Définissez les niveaux de confidentialité documentaire applicables." },
            ],
        },
        {
            id: "inst-tuto-team-manage",
            titre: "Consulter l'annuaire de l'équipe",
            fonctionnaliteId: "inst-team",
            routeCible: "/inst/team",
            etapes: [
                { numero: 1, instruction: "Accédez à Mon Espace > Équipe" },
                { numero: 2, instruction: "Utilisez les filtres de statut", detail: "Visualisez rapidement les agents actifs ou suspendus." },
                { numero: 3, instruction: "Consultez les rôles métiers", detail: "Vérifiez l'attribution des rôles métier pour chaque agent." },
            ],
        },
    ],
    faq: [
