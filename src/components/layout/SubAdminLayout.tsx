// ═══════════════════════════════════════════════════════════
// DIGITALIUM.IO — Layout: SubAdminLayout
// Sub-Admin workspace — dynamic org theming
            ...
            <div className={`flex items-center ${collapsed ? "justify-center" : "gap-2.5"} px-4 py-5`}>
                ...
                {!collapsed && (
                    ...
                    >
                        ...
                        <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Espace SubAdmin</p>
                    </motion.div>
                )}
            </div>
    ...
    return (
        <TooltipProvider delayDuration={0}>
            ...
            <div className="min-h-screen flex bg-[var(--layout-bg)] p-3 gap-3">
                ...
                <motion.aside
                    role="navigation"
                    aria-label="Menu sous-administration"
                    initial={false}
