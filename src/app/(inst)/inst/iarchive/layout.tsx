...
const TABS = [
    { label: "Archives", href: "/inst/iarchive", icon: Archive, exact: true },
    { label: "Coffre-Fort", href: "/inst/iarchive/vault", icon: Lock },
    { label: "Certificats", href: "/inst/iarchive/certificates", icon: Shield },
];
