...
const TABS = [
    { label: "Signatures", href: "/inst/isignature", icon: PenTool, exact: true },
    { label: "En attente", href: "/inst/isignature/pending", icon: Clock, badge: 3 },
    { label: "Workflows", href: "/inst/isignature/workflows", icon: Workflow },
    { label: "Analytics", href: "/inst/isignature/analytics", icon: BarChart3 },
];
...
export default function ISignatureLayout({
    ...
    // Check if we're on a detail page (e.g. /inst/isignature/sig-1)
