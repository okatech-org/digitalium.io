...
const TABS = [
    { label: "Documents", href: "/inst/idocument", icon: FileText, exact: true },
    { label: "Éditeur", href: "/inst/idocument/edit", icon: PenLine },
    { label: "Partagés", href: "/inst/idocument/shared", icon: FolderOpen },
    { label: "Templates", href: "/inst/idocument/templates", icon: FileStack },
];
...
export default function IDocumentLayout({
    ...
    // Hide tabs on detail pages (e.g. /inst/idocument/edit/[id])
    const isDetailPage =
