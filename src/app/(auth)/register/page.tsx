...
// ═══════════════════════════════════════════════════════════════
// DIGITALIUM.IO — Page: Register (2-step)
// Step 1: Account creation | Step 2: Persona selection
// ═══════════════════════════════════════════════════════════════
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center p-4 py-8">
            ...
            <div className="fixed inset-0 -z-10">
                <div
                    className="absolute top-0 right-1/4 w-96 h-96 rounded-full blur-[120px] opacity-20"
                    style={{ background: "#8B5CF6" }}
                />
                <div
                    className="absolute bottom-1/4 left-1/4 w-96 h-96 rounded-full blur-[120px] opacity-15"
                    style={{ background: "#3B82F6" }}
                />
                <div
                    className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full blur-[100px] opacity-10"
