...
// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Layout: iArchive (Admin)
...
const TABS = [
    { label: "Archives", href: "/admin/iarchive", icon: Archive, exact: true },
    { label: "Coffre-Fort", href: "/admin/iarchive/vault", icon: Lock },
    { label: "Certificats", href: "/admin/iarchive/certificates", icon: Shield },
];

export default function AdminIArchiveLayout({
    children,
}: {
