...
// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Layout: iDocument (Admin)
...
const TABS = [
    { label: "Documents", href: "/admin/idocument", icon: FileText, exact: true },
    { label: "Éditeur", href: "/admin/idocument/edit", icon: PenLine },
    { label: "Partagés", href: "/admin/idocument/shared", icon: FolderOpen },
    { label: "Templates", href: "/admin/idocument/templates", icon: FileStack },
];

export default function AdminIDocumentLayout({
    children,
}: {
