...
// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Page: Sécurité & Conformité DIGITALIUM
...
const complianceMetrics = [
    ...
    { label: "Politiques Actives", value: "14", icon: FileCheck, color: "text-emerald-500", bgColor: "bg-emerald-500/10" },
    { label: "Intégrité Logs", value: "100%", icon: Activity, color: "text-teal-500", bgColor: "bg-teal-500/10" },
];
...
export default function DigitaliumCompliancePage() {
            ...
            >
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Tableau de bord de sécurité espaces — DIGITALIUM
                    </p>
                </div>
