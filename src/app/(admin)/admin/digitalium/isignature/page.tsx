        ...
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">iSignature — DIGITALIUM</h1>
                        <p className="text-xs text-muted-foreground">
                            Validation électronique interne avec traçabilité complète
                        </p>
                    </div>
                </div>
                <Button
            ...
            <div className="relative">
                ...
                <Input
                    ...
                    className="h-8 pl-8 text-xs bg-white/5 border-white/10 focus-visible:ring-emerald-500/30"
                />
            </div>
                                    ...
                                    >
                                        ...
                                        <div className="shrink-0">
                                            {activeTab === "to_sign" ? (
                                                <Button
                                                    size="sm"
                                                    className="h-7 text-[10px] bg-gradient-to-r from-emerald-600 to-teal-500"
                                                >
