// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Espace DIGITALIUM: Clients
// Interface de gestion des clients spécifiques
// ═══════════════════════════════════════════════
...
/* ═══════════════════════════════════════════════
   DIGITALIUM CLIENTS PAGE  
   ═══════════════════════════════════════════════ */

export default function DigitaliumClientsPage() {
    ...
    // ─── Dynamic KPIs (Digitalium colored) ──
    const KPIS = [
        { label: "Total Clients", value: String(stats?.total ?? 0), icon: Users, color: "from-emerald-600 to-teal-500" },
        { label: "Prêts à activer", value: String(stats?.prete ?? 0), icon: TrendingUp, color: "from-violet-600 to-indigo-500" },
        { label: "Actifs", value: String(stats?.active ?? 0), icon: CreditCard, color: "from-blue-600 to-cyan-500" },
            ...
            <motion.div variants={fadeUp} className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        className="bg-gradient-to-r from-emerald-600 to-teal-500 text-white border-0 hover:opacity-90 gap-2 text-xs h-8"
                    >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <div className="relative flex-1 w-full sm:max-w-sm">
                    ...
                    <Input
                        ...
                        className="pl-9 h-9 text-xs border-white/10 bg-white/[0.03] focus:border-emerald-500/30"
                    />
                </div>
            </motion.div>
            ...
            {filteredClients.length === 0 ? (
                <motion.div variants={fadeUp} className="py-16 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {search ? "Aucun client trouvé pour cette recherche" : "Aucun client pour ce filtre."}
                    </p>
                </motion.div>
            ) : (
