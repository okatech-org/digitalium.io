// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Page: Workflows de Signature
// ═══════════════════════════════════════════════
...
import { Workflow, Search, Plus, Filter, Download, ChevronRight } from "lucide-react";
...
export default function WorkflowsdeSignaturePage() {
    return (
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Configurez vos circuits de signature.</p>
                    </div>
                </div>
                                ...
                                <div className="flex items-center gap-3 py-2 px-2 rounded-lg hover:bg-white/3 transition-colors cursor-pointer group">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium truncate group-hover:text-violet-300 transition-colors">
                                            Élément {i} — Workflows de Signature
                                        </p>
