...
import { PenTool, Search, Plus, Filter, Download, ChevronRight } from "lucide-react";
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Signez vos documents en toute sécurité.</p>
                    </div>
                </div>
