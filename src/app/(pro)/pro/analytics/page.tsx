...
import { ChartArea, Search, Plus, Filter, Download, ChevronRight } from "lucide-react";
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Statistiques et performances de l organisation.</p>
                    </div>
                </div>
                            ...
                            <React.Fragment key={i}>
                                <div className="flex items-center gap-3 py-2 px-2 rounded-lg hover:bg-white/3 transition-colors cursor-pointer group">
                                    <div className="h-8 w-8 rounded-lg bg-violet-500/10 flex items-center justify-center shrink-0">
                                        <ChartArea className="h-4 w-4 text-violet-400" />
                                    </div>
