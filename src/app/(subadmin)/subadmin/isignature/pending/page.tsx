// ═══════════════════════════════════════════════
// DIGITALIUM.IO — SubAdmin: Signatures en attente
// ═══════════════════════════════════════════════
...
import { Clock, PenTool, Calendar, AlertTriangle } from "lucide-react";
...
export default function SubAdminPendingSignaturesPage() {
    return (
                ...
                {PENDING.map((item, i) => {
                    ...
                    return (
                        <motion.div
                            ...
                            onClick={() => toast.info("Ouverture du document pour signature...")}
                        >
                            {/* Avatar */}
                            ...
                            <Button
                                ...
                                onClick={(e) => { e.stopPropagation(); toast.info("Processus de signature lancé..."); }}
                            >
