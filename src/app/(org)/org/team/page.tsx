// ═══════════════════════════════════════════════
// DIGITALIUM.IO — Page: Équipe (Organisme)
// Gestion des membres de l"organisme
// ═══════════════════════════════════════════════
...
const STATUS_CONFIG: Record<string, { label: string; color: string; dotColor: string; icon: React.ElementType }> = {
    ...
    suspended: { label: "Suspendu", color: "bg-red-500/15 text-red-400 border-red-500/20", dotColor: "bg-red-400", icon: AlertTriangle },
};
        ...
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            >
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Équipe & Collaborateurs</h1>
                        <p className="text-xs text-muted-foreground">
                            Gestion des accès de votre organisme.
                        </p>
                    </div>
                </div>
            </motion.div>
                            ...
                            : filtered.map((member, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    {member.estAdmin && (
                                                        <Crown className="h-3 w-3 text-violet-400 shrink-0" />
                                                    )}
                                                </div>
                                        ...
                                        <div className="flex items-center">
                                            <span className="text-xs text-muted-foreground truncate">{unitName}</span>
                                        </div>
                                        <div className="flex items-center">
